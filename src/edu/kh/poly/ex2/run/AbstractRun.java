...
//		as.ex1();
		...
		Calculator cal = new YESCalculator(); // 협업때? 클래스만 가져와서 변경해 사용할 수 있음. 
		System.out.println("합 : " + cal.plus(20, 14));
		System.out.println("차 : " + cal.minus(20, 14));
		System.out.println("곱 : " + cal.multiple(20, 14));
		System.out.println("몫 : " + cal.divide(20, 14));
